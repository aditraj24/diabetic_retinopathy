  ...
  const features = [
    {
      ...
      description: "Upload retinal photographs and receive AI-computed results in seconds.",
      icon: (
    ...
    <div id="features" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-gray-900">Why use DR-Vision?</h2>
        </div>
