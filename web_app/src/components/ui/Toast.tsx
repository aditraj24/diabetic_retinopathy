  ...
  return (
    <div className="fixed bottom-0 right-0 z-50 p-4 space-y-4 pointer-events-none w-full max-w-sm">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className={`pointer-events-auto w-full overflow-hidden rounded-xl glass-card border-l-4 p-4 animate-fade-in-up ${toast.type === "success" ? "border-l-success-green" :
